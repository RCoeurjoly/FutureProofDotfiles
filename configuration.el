...
;; Use Emacs built-in input methods (Quail) for Chinese.
(setq default-input-method "chinese-py")
(global-set-key (kbd "C-c i c") (lambda () (interactive) (set-input-method "chinese-py")))
...
(use-package consult-projectile
  :bind ("C-c p s" . consult-projectile-ripgrep))
